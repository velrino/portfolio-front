  ...
  const renderCompanies = (
    ...
    return companies.map((company, index) => {
      ...
      return (
        ...
        >
          <div
            className={`p-1 rounded-full shadow-lg border border-white/30 hover:scale-110 hover:shadow-xl hover:border-purple-400 transition-all duration-300 cursor-pointer flex items-center justify-center overflow-hidden animate-counter-spin ${company.bgColor} `}
            style={{
